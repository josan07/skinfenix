...
// @match        *://fenix.tecnico.ulisboa.pt/homepage*
// @grant        none
...
(function() {
    ...
    // Mantém o HTML preto e esconde o corpo até tudo estar pronto
    // ==========================================
    if (currentTheme === 'dark') {
        // Força a raiz imediatamente
        ...
        flashbangShield.textContent = `
            /* Força o canvas do browser a ser preto e esconde o body a carregar */
            :root, html {
                background-color: #121212 !important;
            }
            body {
                background-color: #121212 !important;
                opacity: 0 !important; /* INVISÍVEL DURANTE O LOAD */
    ...
    const colorPalettes = {
        ...
        'orange':  { name: 'Laranja', base: '#f77f00', hover: '#d66800' },
        'gold':    { name: 'Dourado', base: '#ffb703', hover: '#e89d00' },
        'green':   { name: 'Verde', base: '#2a9d8f', hover: '#21867a' },
        'lime':    { name: 'Lima', base: '#a4de02', hover: '#8bc401' },
        'purple':  { name: 'Roxo', base: '#9b5de5', hover: '#7b3eb5' },
        'pink':    { name: 'Rosa', base: '#ff006e', hover: '#cc0058' },
        'silver':  { name: 'Prata', base: '#8d99ae', hover: '#6c7a89' },
    ...
    const customCSS = `
        ...
        /* ==========================================
           CORES DO HORÁRIO (Paleta Análoga Dinâmica)
           ========================================== */
        .fc-event {
            background-color: var(--active-pill-bg) !important;
            border-color: rgba(0,0,0,0.2) !important;
        }
        .fc-event, .fc-event *, .fc-event:hover {
            color: #ffffff !important;
            text-decoration: none !important;
        }
        a.fc-event[title*="Teórica"], a.fc-event[data-original-title*="Teórica"] {
            /* Cor base */
        }
        a.fc-event[title*="Laboratorial"], a.fc-event[data-original-title*="Laboratorial"] {
            filter: hue-rotate(70deg) saturate(1.2) !important;
        }
        a.fc-event[title*="Problemas"], a.fc-event[data-original-title*="Problemas"],
        a.fc-event[title*="Prática"], a.fc-event[data-original-title*="Prática"] {
            filter: hue-rotate(-70deg) saturate(1.2) !important;
        }
        a.fc-event[title*="Dúvidas"], a.fc-event[data-original-title*="Dúvidas"],
        a.fc-event[title*="Avaliação"], a.fc-event[data-original-title*="Avaliação"] {
            filter: grayscale(0.6) brightness(0.7) !important;
        }

        /* Tabela e elementos form */
        ...
        .headerMenuPositioningCluster {
            ...
            margin: 0 !important;
            padding: 0 !important;
            z-index: 99999 !important; /* Keeps the dropdown above other elements */
        }

        #headcounter {
            position: relative !important;
            z-index: 99998 !important; /* Forces the header to sit above the page content */
        }
        ...
        /* ==========================================
           BOTÕES DO CALENDÁRIO (Month, Week, Day, <, >)
           ========================================== */
        .fc-button {
            background-color: var(--bg-content) !important;
            ...
            outline: none !important; /* Tira a borda azul feia do browser */
        }

        /* Hover/Focus APENAS para botões normais (inativos) */
        .fc-button:hover,
        .fc-button:focus {
            background-color: var(--bg-hover) !important;
            color: var(--accent-blue) !important;
        ...
        /* Botão CLICADO ou ATIVO (força a cor do tema SEMPRE) */
        ...
        .fc-button:active {
            ...
            border-color: var(--active-pill-bg) !important;
            box-shadow: none !important;
        }
        ...
        html[data-color="gay"] .fc-event {
            background: linear-gradient(90deg, #FF0018, #FFA52C, #FFFF41, #008018, #0000F9, #86007D) !important;
            background-size: 300% 300% !important;
            animation: rainbowBG 6s ease infinite !important;
            border: none !important;
            filter: none !important; /* Desliga o filtro de cor das aulas para não estragar o arco-íris */
        }
    ...
    function initUI() {
        // Remove a cortina de blackout quando tudo estiver carregado
